...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-blue-700 text-slate-50 shadow hover:bg-blue-800 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50/90",
        destructive:
          "bg-red-500 text-slate-50 shadow-sm hover:bg-red-600 dark:bg-red-900 dark:text-slate-50 dark:hover:bg-red-900/90",
        outline:
        ...
        secondary:
          "bg-slate-100 text-slate-900 shadow-sm hover:bg-slate-100/80 border dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-800/80",
        ghost: "px-1 font-medium hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-slate-500 dark:hover:text-slate-50",
